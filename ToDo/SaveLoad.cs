...
namespace ToDo
{
    ...
    {   
        public static void SaveTasks(string path)
        {
            ...
            {
                strings[i] = string.Format("id:{0},name:{1},done:{2},date:{3}", TaskTracker.taskList[i].getId(), TaskTracker.taskList[i].Title, TaskTracker.taskList[i].State, TaskTracker.taskList[i].date.ToString());
            }
